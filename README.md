...
Para crear un fork debes iniciar sesión en github y luego ingresar a la landing page del proyecto del que quieres sacar tu Fork.
...
Agregar remotos
`git remote add EDgit https://github.com/teamA-C/EDgit.git`
